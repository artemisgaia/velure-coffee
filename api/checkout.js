const PRODUCT_CATALOG = {
  ...
  'bloom-pods': { name: 'BLOOM', price: 18.0 },
  'hazel-pods': { name: 'HAZEL', price: 18.0 },
  molten: { name: 'MOLTEN', price: 19.0 },
  drift: { name: 'DRIFT', price: 27.0 },
  nougat: { name: 'NOUGAT', price: 27.0 },
  praline: { name: 'PRALINE', price: 27.0 },
  citra: { name: 'CITRA', price: 27.0 },
  zest: { name: 'ZEST', price: 27.0 },
  ember: { name: 'EMBER', price: 28.0 },
  forge: { name: 'FORGE', price: 28.0 },
  forest: { name: 'FOREST', price: 29.0 },
  grove: { name: 'GROVE', price: 29.0 },
  sable: { name: 'SABLE', price: 30.0 },
  cerise: { name: 'CERISE', price: 30.0 },
  cacao: { name: 'CACAO', price: 29.0 },
...
const isAllowedOrigin = (req) => {
  ...
  // Always allow our own known domains regardless of the allowlist
