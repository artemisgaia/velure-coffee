...
const PRODUCT_CATALOG = {
  ...
  'bloom-pods': { name: 'BLOOM', priceCents: 1800 },
  'hazel-pods': { name: 'HAZEL', priceCents: 1800 },
  molten: { name: 'MOLTEN', priceCents: 1900 },
  drift: { name: 'DRIFT', priceCents: 2700 },
  nougat: { name: 'NOUGAT', priceCents: 2700 },
  praline: { name: 'PRALINE', priceCents: 2700 },
  citra: { name: 'CITRA', priceCents: 2700 },
  zest: { name: 'ZEST', priceCents: 2700 },
  ember: { name: 'EMBER', priceCents: 2800 },
  forge: { name: 'FORGE', priceCents: 2800 },
  forest: { name: 'FOREST', priceCents: 2900 },
  grove: { name: 'GROVE', priceCents: 2900 },
  sable: { name: 'SABLE', priceCents: 3000 },
  cerise: { name: 'CERISE', priceCents: 3000 },
  cacao: { name: 'CACAO', priceCents: 2900 },
