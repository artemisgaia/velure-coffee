...
const PRODUCT_CATALOG = {
  ...
  'bloom-pods': { name: 'BLOOM', subtitle: 'Fruity Bloom Coffee Pods', price: 18 },
  'hazel-pods': { name: 'HAZEL', subtitle: 'Rich Hazelnut Coffee Pods', price: 18 },
  molten: { name: 'MOLTEN', subtitle: 'Molten Caramel Coffee Pods', price: 19 },
  drift: { name: 'DRIFT', subtitle: 'Citrus Drift Coffee Beans', price: 27 },
  nougat: { name: 'NOUGAT', subtitle: 'Praline Smooth Coffee Beans', price: 27 },
  praline: { name: 'PRALINE', subtitle: 'Rich Hazelnut Coffee Beans', price: 27 },
  citra: { name: 'CITRA', subtitle: 'Fruity Bloom Coffee Beans', price: 27 },
  zest: { name: 'ZEST', subtitle: 'Lemon Glaze Coffee Beans', price: 27 },
  ember: { name: 'EMBER', subtitle: 'Deep Roast Coffee Beans', price: 28 },
  forge: { name: 'FORGE', subtitle: 'Molten Caramel Coffee Beans', price: 28 },
  forest: { name: 'FOREST', subtitle: 'Forest Decaf Coffee Beans', price: 29 },
  grove: { name: 'GROVE', subtitle: 'Maple Grove Coffee Beans', price: 29 },
  sable: { name: 'SABLE', subtitle: 'Velvet Cocoa Coffee Beans', price: 30 },
  cerise: { name: 'CERISE', subtitle: 'Cherry Zest Coffee Beans', price: 30 },
  cacao: { name: 'CACAO', subtitle: 'Chocolate Bold Coffee Beans', price: 29 },
